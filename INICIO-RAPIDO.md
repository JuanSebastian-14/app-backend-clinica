...
**Desde tu IDE:**
- Ejecuta la clase `EspirituApplication.java`
...
```bash
mysql -u root -p espiritu_db < datos-prueba.sql
```
...
- [ ] Base de datos `espiritu_db` creada o configurada para creación automática
